...
If you want the Native Google Sign In, create a 
- OAuth-Client Id for a web application with the redirect url `https://SUPABASE_ID.supabase.co/auth/v1/callback`,
- OAuth-Client Id for a android app with the packageName `io.github.jan.supabase.android` and your SHA1 fingerprint (you can get the fingerprint via the gradle task `signingReport`)
