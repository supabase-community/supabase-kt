...
*Note: [WASM](https://github.com/supabase-community/supabase-kt/issues/86) build available: [2.4.5-wasm0](https://github.com/supabase-community/supabase-kt/releases/tag/2.5.4-wasm0)*
