...
*Note: [WASM](https://github.com/supabase-community/supabase-kt/issues/86) build available: [2.0.2-wasm0](https://github.com/supabase-community/supabase-kt/releases/tag/2.0.2-wasm0)*
